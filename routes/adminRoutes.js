...
router.get("/dashboard", authmiddleware, adminController.getAdminPage);
...
router.get("/view-student/:studentId", authmiddleware,  adminController.getViewStudentPage);
router.delete("/delete-student/:studentId", authmiddleware, adminmiddleware, adminController.deleteStudent);
router.get("/add-monthly-fees", authmiddleware,  adminController.getAddMonthlyFeesPage);
...
router.get("/download-receipt/:studentId/:month/:year", authmiddleware,  adminController.downloadReceipt);
